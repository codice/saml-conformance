...
fun main(args: Array<String>) {
    ...
    parser.option("i",
            ...
            default = System.getProperty("user.dir") + "/distribution/src/main/resources/idp-metadata.xml")

    parser.option("p",
            listOf("plugins"),
            description = "Path to the plugins directory",
            default = System.getProperty("user.dir") + "/distribution/target/distribution-1.0-SNAPSHOT-bin/plugins")
